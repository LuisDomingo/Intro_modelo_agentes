...
author: "Domingo Martínez, Cruz Carmen, Gómez Almanza Johan Alexander, Pedroza Franco Jimena, Sánchez Rojano Norman Roberto, Ortiz Pimentel Francisco Israel, Metztli Tamara Guerrero Rodriguez, Tafoya Ledesma Dante Israel, Arturo Pulido Balderas, Bardomiano Martínez Ana Cecilia, Ruiz Soto Valentina, Delgado Cancino Diego Enrique"
...
En el script vamos a simular como actua el Covid-19 en el aula de la ENCiT
Vamos a simular dos tipos de agentes, los que usan cubrebocas y los que no lo usan
Se tiene 3 posibles estados: expuesto, infectados y suseptibles.
...
```
## Interpretación 
Tenemos a los dos agentes, los que usan y no usan cubrebocas, y a cada uno se le asigna un "estado" de susceptible "S", expuesto "E", e infectado "I". 
10 agentes empiezan siendo susceptibles, y a medida que avanzan los días (20), su estado cambia a expuestos o infectados, debido al contacto con personas que no usan cubrebocas. Con ello, podemos decir que los estados "S", "E", e "I", dependerán del contacto que tengan los agentes "S", con los "I" para que presenten un estado de infección, tomando en cuenta, el uso de cubrebocas en el espacio ENCiT. 

```{r}
# De las 20 veces que se repitió el modelo (una por cada población de agentes generada), se calculan los promedios de infectados para cada día.
